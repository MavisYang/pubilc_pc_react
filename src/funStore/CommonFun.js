...
export const TimeDate3 = (strTime)=>{
    //2018/11/28 16:30->2018-11-21 12:00:00"
    return strTime.slice(0,16).replace(/\//g,'-')
}
...
export const optionValue = (value,optionsData) => {
    const index = optionsData.paramaValue.indexOf(value)
